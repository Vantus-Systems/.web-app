...
3.  **Verify** imports, types, and logic flow.
    _The codebase is active and changes frequently. Relying on memory or assumptions will lead to errors._
...
- When explaining, focus on the _why_ of the backend logic.
