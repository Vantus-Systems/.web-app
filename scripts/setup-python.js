...
(() => {
  ...
  try {
    ...
    log(
      "python3 not found. Admin verification (playwright) will be unavailable.",
    );
  ...
  if (pipInstalled) {
    ...
    log(
      "Failed to install playwright via pip. You may need to install pip3 manually.",
    );
  }
