      ...
      <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-2xl font-black text-slate-900 group-hover:text-primary-700 transition-colors">{{ prog.name }}</h3>
          ...
          <p class="text-slate-500 mb-6">{{ prog.description || "No description available." }}</p>
          <div class="text-primary-600 font-bold text-sm flex items-center gap-2">
            View Program
