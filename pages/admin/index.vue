        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <BaseCard>
              <template #header>
                <div class="flex items-center justify-between">
                  <h3 class="text-lg font-bold text-primary-900">
                    Pricing Architecture (JSON)
                  </h3>
                  <div class="flex space-x-2">
                    <span
                      class="px-2 py-1 bg-slate-100 rounded text-[10px] font-bold text-slate-500 uppercase"
                      >Read-Only Validation</span
                    >
                  </div>
                </div>
              </template>
              <p class="mb-6 text-sm text-slate-500 italic">
                Directly modify the pricing schema below. This controls the
                multi-tier pricing tables on the public site.
              </p>
              <form @submit.prevent="savePricing">
                <div class="relative group">
                  <div
                    class="absolute -inset-1 bg-gradient-to-r from-gold/20 to-primary-500/20 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000"
                  ></div>
                  <textarea
          ...
          <div v-if="currentTab === 'schedule'">
            <BaseCard>
              ...
              <p class="mb-6 text-sm text-slate-500 italic">
                Update the weekly session schedule. Ensure all time slots are
                formatted correctly for the timeline component.
              </p>
