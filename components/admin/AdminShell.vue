<template>
  <div class="min-h-screen bg-slate-50 font-sans text-slate-900 h-screen flex flex-col overflow-hidden">
    <nav class="bg-primary-950 shadow-2xl border-b border-primary-800 sticky top-0 z-50 shrink-0">
        ...
        <div class="flex justify-between h-20">
          <div class="flex items-center gap-6">
            <div class="flex-shrink-0 flex items-center">
              ...
              <div class="ml-4 px-2 py-0.5 bg-gold/10 border border-gold/20 rounded text-[10px] text-gold font-bold tracking-widest uppercase">
                Admin
              </div>
            </div>
          </div>
          <div class="flex items-center space-x-4">
            <div class="hidden md:flex flex-col items-end mr-4">
              ...
              <span class="text-[10px] text-slate-400 uppercase tracking-widest">{{ roleLabelText }}</span>
            </div>
            <button
    ...
    <div class="flex flex-1 relative z-10 min-h-0">
      ...
      <main class="flex-1 flex flex-col min-w-0 bg-slate-50/50">
        <div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-12">
          <header class="mb-8">
            <p class="text-gold font-bold text-xs uppercase tracking-[0.2em] mb-1">
              {{ subtitle }}
            </p>
