<template>
  <div class="grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)_320px] h-full">
    ...
    <div class="flex flex-col gap-4 h-full overflow-y-auto">
      ...
      <div
        class="bg-surface border border-divider rounded-xl p-8 flex flex-col items-center gap-6 shadow-sm flex-1 min-h-[400px] justify-center relative"
      >
        <div
        ...
        <div class="grid grid-cols-5 gap-2 bg-base p-3 rounded-xl shadow-inner">
          <div
            ...
            :class="[
              val === 1 && idx !== 12
                ? 'bg-accent-primary scale-105 border-accent-primary'
        ...
        <div
          ...
          class="w-full overflow-x-auto pb-2 flex justify-center"
        >
    ...
    >
      ...
      <div class="p-4 space-y-6 overflow-y-auto flex-1">
        <div class="space-y-4">
          ...
          <label
            class="flex items-center gap-3 p-3 rounded-lg border border-divider bg-base/50 cursor-pointer hover:bg-base transition-colors"
          >
            <input
...
const activeFrame = computed<Frame>(() => {
  return normalizeFrame(
    form.value.definition.frames?.[currentFrameIndex.value],
  );
});
