    ...
    >
      ...
      <div class="space-y-6">
        ...
        <div class="bg-primary-50 p-6 rounded-2xl border border-primary-100">
          <label class="block text-xs font-bold text-primary-700 uppercase tracking-wider mb-2">
            Current Progressive
          </label>
          <div class="relative">
            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-2xl font-bold text-primary-400">$</span>
            <input
          ...
          <div class="mt-4 flex items-center justify-between text-xs font-medium text-slate-500">
            <span>Cap: $5,000</span>
            <span :class="{'text-green-600 font-bold': progressive.current >= 5000}">
