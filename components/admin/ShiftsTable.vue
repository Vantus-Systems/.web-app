      ...
      <table class="min-w-full text-xs">
        ...
        <tbody class="divide-y divide-slate-100">
          ...
          >
            ...
            <td class="px-6 py-4 text-right font-mono text-slate-600">
              {{
                shift.deposit_actual
                  ? formatCurrency(shift.deposit_actual)
                  : "-"
              }}
            </td>
            <td
            ...
            <td class="px-6 py-4">
              <p
                v-if="shift.notes"
                class="truncate max-w-[200px] text-slate-500 italic"
                :title="shift.notes"
              >
                {{ shift.notes }}
              </p>
...
const calculateVariance = (shift: ShiftRecord) => {
  if (shift.deposit_actual === null || shift.deposit_actual === undefined)
    return "-";
