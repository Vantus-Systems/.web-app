<template>
  <div class="space-y-8">
    <BaseCard class-name="space-y-6">
      ...
      <!-- Sunday & Specials Tab -->
      <div
        v-if="activeTab === 'sunday'"
        class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500"
      >
        <div class="bg-gold/5 border border-gold/20 rounded-2xl p-6">
          <h4 class="text-lg font-black text-gold-800 mb-4">
            Sunday Exclusives
          </h4>
          <div class="grid gap-4 md:grid-cols-2">
            <input
          ...
          <div class="mt-6">
            <div class="flex items-center justify-between mb-4">
              <span
                class="text-xs font-bold uppercase tracking-widest text-gold-700"
                >Specials List</span
              >
              <button
                class="text-xs bg-white border border-gold/20 text-gold-700 px-3 py-1 rounded-full font-bold"
              ...
              >
                <div class="grid md:grid-cols-3 gap-3">
                  <input
                    ...
                    placeholder="Name"
                    class="text-sm border-slate-100 bg-slate-50 rounded-lg"
                  />
                  <input
                ...
                <div class="mt-2 flex justify-between items-center">
                  <input
                    ...
                    placeholder="Description"
                    class="text-xs border-transparent w-full mr-4 text-slate-500"
                  />
                  <button
        ...
        <div class="space-y-4">
          ...
          >
            <input
              ...
              class="block w-full text-base font-bold text-primary-900 border-none p-0 focus:ring-0 placeholder-slate-300 mb-2"
            />
            <textarea
              v-model="faq.answer"
              placeholder="Answer"
              rows="2"
              class="block w-full text-sm text-slate-600 border-none p-0 focus:ring-0 bg-slate-50 rounded-lg px-3 py-2"
            />
