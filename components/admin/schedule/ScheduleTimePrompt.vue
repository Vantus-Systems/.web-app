<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-base/80 backdrop-blur-sm p-4">
    <div class="bg-surface border border-divider rounded-xl shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
      <div class="p-6">
        ...
        <div class="space-y-4">
          <label class="block">
            <span class="text-xs font-bold text-tertiary uppercase mb-1 block">Time</span>
            <input
              v-model="time"
              type="time"
      ...
      <div class="flex items-center justify-end gap-3 p-4 bg-base/50 border-t border-divider">
        <button 
