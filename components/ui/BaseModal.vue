  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        >
          <!-- Header -->
          <div v-if="title || $slots.header" class="flex items-center justify-between border-b border-neutral-100 px-6 py-4">
            <h3 v-if="title" class="text-lg font-semibold text-emerald-900">{{ title }}</h3>
            <slot name="header" />
            <button
              @click="close"
